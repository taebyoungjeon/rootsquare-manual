...
const DEFAULT_INVENTORY_ITEMS = [
  ...
  { name: "쌀크림 베이스", category: "베이스", unit: "피처", min: 1, weekendMin: 3 },
  { name: "딸기 베이스", category: "베이스", unit: "피처", min: 1, weekendMin: 3 },
  ...
  { name: "복숭아 베이스 (농축액)", category: "베이스", unit: "통", min: 2, weekendMin: 2 },
  { name: "복숭아 과일 (냉동)", category: "과일", unit: "팩", min: 4, weekendMin: 6 },
  { name: "블루베리 베이스 (리플잼)", category: "베이스", unit: "팩", min: 2, weekendMin: 2 },
